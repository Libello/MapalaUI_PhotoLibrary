      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="inner cover">
            <h1 class="cover-heading" id="sekretariatmapala">Mapala Universitas Indonesia</h1>
            <p class="detail">@Mapala_UI || mapala_ui@yahoo.com<br>
              Gedung Pusat Kegiatan Mahasiswa lt. 1<br>
